...
def get_april_birthdays(people):
    # Return those people in input list `people` with birthdays in the month of April.
    # people is a list of Person objects.
    # Return a list of Person objects whose birthday falls in the month of April.
    april_birthdays = {}
...
def get_most_common_month(people):
    #TODO:
    #Use the 'months' dictionary to record counts of birthday months for persons in
    #the "people" data.
